...
| [he_to_binary_mask_final](https://github.com/ruchikavermavaid/MoNuSeg/blob/master/he_to_binary_mask_final.m) | Convert H&E mpute average AJI across all nuclei for each image of each participant|
